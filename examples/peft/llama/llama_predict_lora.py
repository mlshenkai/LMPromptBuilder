...
model = LlamaModelPeft("llama", "shibing624/chinese-alpaca-plus-7b-hf", peft_name=f"/code-online/shenkai/textgen/examples/llama/outputs")
test_file = f"{project_path}/resources/data/中英品名0512.txt"
test_data = load_data(test_file)[:1]
...
out_df.to_json(f'{project_path}/resources/data/test_result.json', force_ascii=False, orient='records', lines=True)
