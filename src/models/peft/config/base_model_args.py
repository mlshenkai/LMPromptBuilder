# -*- coding: utf-8 -*-
# @Author: watcher
# @Created Time: 2023/5/16 11:21 AM
# @File: base_model_args
...
class ModelArgs:
    ...
    def save(self, output_dir):
        ...
        with open(
            os.path.join(output_dir, "model_args.json"), "w", encoding="utf-8"
        ) as f:
            args_dict = self.get_args_for_saving()
            if args_dict["dataset_class"] is not None and not isinstance(
                args_dict["dataset_class"], str
            ):
