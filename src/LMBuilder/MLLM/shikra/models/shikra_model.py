...
from transformers import CLIPImageProcessor, CLIPVisionModel, CLIPModel, AutoModel, AutoProcessor
...
class ShikraLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig, mm_vision_tower=None, mm_hidden_size=None):
        ...
        # self.vision_tower = AutoModel.from_pretrained('openai/clip-vit-large-patch14')
    ...
    def initialize_vision_modules(self, vision_tower_name, mm_vision_select_layer,
